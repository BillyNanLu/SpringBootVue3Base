...
public class Demo {
    public static void main(String[] args) throws Exception {
        ...
        String bucketName = "breaking-new";
        ...
        try {
            ...
            PutObjectRequest putObjectRequest = new PutObjectRequest(bucketName, objectName, new FileInputStream("/Users/nanlu/Downloads/001.jpg"));
